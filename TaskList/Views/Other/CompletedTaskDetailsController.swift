//
//  CompletedTaskDetailsController.swift
//  TaskList
//
...
class CompletedTaskDetailsController: UIViewController {
    ...
    lazy var deleteTaskButton: UIButton = {
        ...
        button.setImage(UIImage(systemName: "trash", withConfiguration: UIImage.SymbolConfiguration(font: UIFont.systemFont(ofSize: 18, weight: .bold))), for: .normal)
        return button
    }()
    ...
    func configureViewComponents() {
        ...
        deleteTaskButton.anchor(bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, paddingBottom: -20, paddingRight: -20, width: 70, height: 70)
    }
}
